...
func (r *ReconcileIssuer) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("### DEBUG ### v1alpha1 Issuer created", "Issuer.Namespace", instance.Namespace, "Pod.Name", instance.Name)

	reqLogger.Info("### DEBUG ### Creating v1 Issuer", "Issuer.Namespace", instance.Namespace, "Pod.Name", instance.Name)
	...
	if err := r.client.Create(context.TODO(), &v1Issuer); err != nil {
		// if err == already exists, continue

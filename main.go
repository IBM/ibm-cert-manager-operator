...
import (
	...
	"github.com/IBM/ibm-cert-manager-operator/controllers"
...
func init() {
	...
	// to resolve error {"error": "no kind is registered for the type v1.APIService in scheme \"pkg/runtime/scheme.go:101\""}
	// All types you want to use must be added to your scheme.
	// The default Kubernetes scheme (which is used in CR if none is specified) contains most of the main Kubernetes types, but does not contain CRDs.
	utilruntime.Must(apiextensionsAPIv1beta1.AddToScheme(scheme))

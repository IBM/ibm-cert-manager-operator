...
import (
	acme_cert_managerv1 "github.com/ibm/ibm-cert-manager-operator/v1apis/acme.cert-manager/v1"
	meta_cert_managerv1 "github.com/ibm/ibm-cert-manager-operator/v1apis/meta.cert-manager/v1"
...
func (in *IssuerConfig) DeepCopyInto(out *IssuerConfig) {
	*out = *in
	if in.ACME != nil {
		...
		*out = new(acme_cert_managerv1.ACMEIssuer)
		(*in).DeepCopyInto(*out)
	}
	if in.CA != nil {
		in, out := &in.CA, &out.CA
...
func (in *IssuerStatus) DeepCopyInto(out *IssuerStatus) {
	*out = *in
	...
	if in.ACME != nil {
		in, out := &in.ACME, &out.ACME
		*out = new(acme_cert_managerv1.ACMEIssuerStatus)
		**out = **in
	}
}
